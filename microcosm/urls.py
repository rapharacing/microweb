...
urlpatterns = patterns('',
    ...
    url(r'^events/(?P<item_id>\d+)/$', EventView.single, name='single-event'),
    url(r'^events/(?P<item_id>\d+)/edit/$', EventView.edit, name='edit-event'),
    url(r'^events/(?P<item_id>\d+)/delete/$', EventView.delete, name='delete-event'),
    # RSVP to an event
    ...
    url(r'^conversations/(?P<item_id>\d+)/$' , ConversationView.single, name='single-conversation'),
    url(r'^conversations/(?P<item_id>\d+)/edit/$', ConversationView.edit, name='edit-conversation'),
    url(r'^conversations/(?P<item_id>\d+)/delete/$', ConversationView.delete, name='delete-conversation'),
